...
(function (root, factory) {
  ...
  function stepFrame(paper, worldAt, dtFrame) {
    ...
    // plastic flow on crease hinges (geometric yield: curvature > 1/rCrease)
